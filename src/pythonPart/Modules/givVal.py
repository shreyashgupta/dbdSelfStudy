...
def givVal(model_answer, keywords, answer, out_of):
    ...
    q = max(1,6-math.ceil(fuzz.token_set_ratio(model_answer, answer) * 6 / 100))
...
# print(givVal(sys.argv[1],"",sys.argv[2],10))
print(givVal("NO this is not possible asfds f sd d g dfh fg hj fgj","","NO this is not possibl df h fdgh  fgj gh ke",10))
